...
def nonlin_cg(comm, experiment, args, postprocess=None):
    ...
    a, L = variational_form(dxL, v1, p1, d1, q1, v0, p0, d0, q0, a, h, b, c, grad_d0,  dt, n_F, args, H=H, f= None, p_dirichlet_bcs_exist = p_dirichlet_bcs_exist)
...
def variational_form(dxL, v1, p1, d1, q1, v0, p0, d0, q0, a, h, b, c, grad_d0, dt, normal_F, args, H=None, f= None, p_dirichlet_bcs_exist = False):
        """
