...
def linear_method(experiment, args, projection: bool, use_mass_lumping: bool, postprocess=None, solver_metadata = {"ksp_type": "richardson", "pc_type": "lu", "pc_factor_mat_solver_type": "mumps"}):
    """
