...
def LL2(experiment, args, postprocess=None, solver_metadata = {"ksp_type": "preonly", "pc_type": "lu", "pc_factor_mat_solver_type": "mumps"}):
    """
...
def Lh(experiment, args, postprocess=None, solver_metadata = {"ksp_type": "preonly", "pc_type": "lu", "pc_factor_mat_solver_type": "mumps"}):
    """
...
def LL2P(experiment, args, postprocess=None, solver_metadata = {"ksp_type": "preonly", "pc_type": "lu", "pc_factor_mat_solver_type": "mumps"}):
    """
    linear solver without projection and without mass-lumping
    """
...
def LhP(experiment, args, postprocess=None, solver_metadata = {"ksp_type": "preonly", "pc_type": "lu", "pc_factor_mat_solver_type": "mumps"}):
    """
    linear solver without projection and with mass-lumping
    """
